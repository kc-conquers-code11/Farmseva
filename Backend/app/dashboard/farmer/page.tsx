          ...
          <div className="mb-8">
            ...
            >
              ...
              <p className="text-neutral-600">
                Your pig & poultry dashboard with live insights
              </p>
            </motion.div>
          </div>
              ...
              <Card>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs text-neutral-500">
                    Provider: Other (configure /api/weather)
                  </span>
                </div>
                <div className="space-y-4">
            ...
            >
              <Card>
                <div className="flex items-center mb-6">
                  ...
                  />
                  <h2 className="text-xl font-medium text-neutral-800">
                    Risk Assessment (Pig & Poultry)
                  </h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <select
                    value={riskForm.animal}
                    onChange={(e) =>
                      setRiskForm({
                        ...riskForm,
                    ...
                    className="px-3 py-2 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-sm"
                  >
                    <option>Pig</option>
                    <option>Poultry</option>
                  </select>
                  <select
                    value={riskForm.state}
                    onChange={(e) =>
                      setRiskForm({
                        ...riskForm,
                  ...
                  {[
                    ...
                    >
                      ...
                      <p className="text-xs text-neutral-600 mt-2">
                        Connect your providers in /api/weather and
                        /api/prices to power these scores.
                      </p>
                    </div>
                  ))}
                </div>
              ...
              <Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    {
                      name: 'African Swine Fever (Pig)',
                      risk: 'medium',
                      advice:
                        'Strict biosecurity, isolate new stock, control vectors.',
                    },
                    {
                      name: 'Avian Influenza (Poultry)',
                      risk: 'low',
                      advice:
                        'Limit wild bird contact, disinfect equipment regularly.',
                    },
                    {
                      name: 'Coccidiosis (Poultry)',
                      risk: 'high',
                      advice:
                        'Maintain litter dryness, consider prophylaxis as per vet.',
                    },
                  ].map((d) => (
                    <div
                      key={d.name}
              ...
              <Card>
                ...
                <div className="space-y-3">
                  {securityAlerts.map((a, i) => (
                    <div
                      key={i}
                      className="p-4 rounded-lg bg-white border border-neutral-200"
                    >
                      <div className="flex items-start gap-3">
                        <Icon
                          icon={a.icon}
                ...
                <div className="mt-4 text-xs text-neutral-500">
                  Report suspicious activity from any product page or
                  contact support.
                </div>
              </Card>
            </motion.div>

      ...
      <div data-editor-id="app/components/Navbar.tsx:25:7" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div data-editor-id="app/components/Navbar.tsx:26:9" className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <Image
              src="/team/logo.png" // Path to your logo in the public folder
              alt="FarmSeva Logo"
              width={40} // Set the desired width of the logo icon
              height={40}  // Set the desired height of the logo icon
              className="rounded-full object-cover" // Makes the logo circular and prevents stretching
              priority // Add priority to load the logo fast
            />
            <span className="text-xl font-semibold text-green-800">FarmSeva</span>
          </Link>
            ...
            {menuItems.map((item, index) => {
              ...
              return (
                <Link
                  ...
                  className={
                    isActive
                      ? 'bg-green-600 text-white px-3 py-2 rounded-full text-sm font-medium'
                      : 'text-neutral-600 hover:text-green-600 transition-colors duration-200 text-sm font-medium'
                  }
                >
                  {item.name}
                </Link>
            ...
            {menuItems.map((item, index) => {
               ...
               return (
                <Link
                  ...
                  className={
                    isActive
                      ? 'block py-2 px-4 text-white bg-green-600 rounded-lg'
                      : 'block py-2 px-4 text-neutral-600 hover:text-green-600 hover:bg-green-50 transition-colors duration-200'
                  }
